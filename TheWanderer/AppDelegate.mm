...
//  The Wanderer
//
//  Created by Heejo Suh on Tuesday, December 20, 2016
//  Copyright (c) Heejo Suh. All rights reserved.
//
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSString* projectPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"TheWanderer.codea"];
